  ...
  "true": {
    main: {
      ...
      aboutMe: [
        ...
        "I was born in Krasnoyarsk, but now I live in Moscow and study at the Faculty of Information Technology at Moscow State Pedagogical University. I like listening to music, and I also like rock climbing. Recently I started coding. After I took a course in web development, I started freelance assignments and left my regular job.",
        "Portfolio",
        "Static website",
        "Adaptive website",
  ...
  "false": {
    main: {
      ...
      aboutMe: [
        ...
        "Я родился в Красноярске, но сейчас живу в Москве, учусь на факультете информационных технологий МПУ. Я люблю слушать музыку, а ещё увлекаюсь скалолазанием. Недавно начал кодить. После того, как прошёл курс по веб-разработке, начал заниматься фриланс-заказами и ушёл с постоянной работы.",
        "Портфолио",
        "Статичный сайт",
        "Адаптивный сайт",
