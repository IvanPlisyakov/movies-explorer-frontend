...
function SearchForm(props) {
  ...
  const searchForm = (
    <div className="search-form__form">
      ...
      <p className="search-form__checkbox-title">{translations[translationContext].searchForm[0]}</p>
    </div>
  );
    ...
    <section className="search-form">
      <div className="search-form__block">
        <div className="search-form__block-input">
          ...
          <input className="search-form__input" value={movie} onChange={handleChangeMovie} type="text" placeholder={translations[translationContext].searchForm[1]} required/>
